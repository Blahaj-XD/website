      ...
      <div className="content-wrapper">
        <Balance balance={1000000}>
          <div className="flex space-x-2">
            <button className="p-2 flex items-center rounded-xl text-Secondary-White-1 bg-Secondary-Black-1 space-x-3">
              Tambah Saldo{' '}
              <Image
            ...
            <button className="p-2 flex items-center rounded-xl border-2 text-Secondary-Black-1 border-Secondary-Black-1 space-x-2">
              Penarikan Saldo{' '}
              <Image
